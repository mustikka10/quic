...
enum {
	QUIC_SACK_FLAG_NONE, /* No SACK pending (idle timeout) */
...
struct quic_inqueue {
	...
	struct list_head recv_list;      /* Frames ready for user delivery */
	...
	u8 grease_quic_bit:1;  /* rfc9287.html#section-3 */
	u8 stateless_reset:1;  /* rfc9000#section-18.2 */
	u8 ack_delay_exponent; /* rfc9000#section-18.2 */
	u16 max_datagram_frame_size; /* rfc9000#section-18.2 */
